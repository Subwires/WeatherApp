...
// the main render method for the iphone component
   render() {
      ...
      return (
            //Links are used to control routing between different pages of the app // f
            <nav class={ style.container }>
                ...
                <Link activeClassName="active" href="/rain-radar"><div class={ style.bottombutton }><i class="fa fa-map-o"></i></div></Link>
            </nav>
        );
    }
}
